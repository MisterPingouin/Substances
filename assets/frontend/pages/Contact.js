...
const Contact = () => {
  ...
  <div class="text-colorbrown border-t w-[85%] mt-8 border-black  "></div>
      ...
      <main className="flex-grow justify-center items-center min-h-full">
        ...
        <h1 className="text-7xl p-4 lg:p-0 lg:mt-24 text-colorbrown pt-20 mr-20 lg:mb-6 lg:mr-0 pr-14 lg:pr-0 font-bold w-2/3 lg:w-[85%]">
            <span className="block">Contactez-moi</span>
          </h1>
          <h2 className="text-4xl p-4 lg:p-0 lg:mb-8 text-colorbrown mr-20 lg:mr-0 pr-8 font-subtitlefont w-2/3 lg:w-[85%]">
          Choisissez l’objet
...
c’est à vous de jouer !
          ...
          <div className="p-4 text-colorbrown mr-20 lg:mr-0 pr-14 lg:pr-0 font-bold w-2/3 lg:flex lg:flex-col lg:justify:center lg:items-center lg:w-full lg:p-0">
            <div className="space-y-4  lg:w-[85%]">
            ...
            <form className="mt-8 space-y-6 lg:w-[85%]" onSubmit={handleSubmit}>
