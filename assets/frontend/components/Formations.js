...
const Formations = () => {
 ...
 <div className="flex flex-col text-colorbrown text-3xl mt-14 font-subtitlefont w-3/4 pl-4 pr-10 lg:w-[80%] lg:p-0 lg:pr-0">
            ...
            {formation.image && (
  <div className="relative overflow-hidden w-full max-w-4xl h-[16em] flex items-center"> {/* Ajustez h-[200px] selon la hauteur désirée */}
    <img
      src={formation.image}
      alt={formation.titre}
    ...
    />
              ...
              <h1 className="text-7xl font-bold font-titlefont mt-20">{formation.titre}</h1>
