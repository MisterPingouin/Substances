...
const Logo = () => {
  ...
  <div className="text-colorbrown border-t w-[80%] mt-14 border-black  "></div>
      ...
      <div className="text-colorbrown border-t border-black w-[90%] ml-8 mr-20 mx-auto relative z-10 lg:hidden"></div>
    ...
    <div className="flex space-x-10 items-center cursor-pointer max-w-[60%] ">
        {logos.map((logo) => (
            <div
                ...
                className=""
            >
                <img src={logo.logoPath} alt="Logo" className='h-auto w-auto'/>
            </div>
        ))}
    </div>
            </div>
